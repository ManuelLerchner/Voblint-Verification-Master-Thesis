...
SESSIONS="Voblint_VIMP Voblint_Domain Voblint_Solver Voblint_CFG Voblint_Framework Voblint_Compile Voblint_Exec Voblint_Analysis Voblint_Soundness Voblint_Examples"
