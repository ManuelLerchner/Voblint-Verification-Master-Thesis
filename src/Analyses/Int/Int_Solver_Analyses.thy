...
text \<open>
  ...
  (\<^theory>\<open>Voblint_Analysis_Int.Int_Exec_Sound\<close>) already solves \<open>analyse_int_dg_eqs_for\<close>
...
text \<open>
  ...
  (\<^theory>\<open>Voblint_Analysis_Int.Int_Exec_Sound\<close>), which the routed spine's keyed-seed
...
text \<open>
  ...
  \<^theory>\<open>Voblint_Analysis_Int.Int_Exec_Sound\<close>) now also holds at the routed spine, orthogonally
