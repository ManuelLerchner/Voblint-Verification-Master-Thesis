...
text \<open>
  ...
  \<open>Voblint_Analysis_Base.Abstract_Arithmetic\<close>'s \<open>expression_domain_sound\<close> locale,
...
text \<open>
  ...
  \<open>Voblint_Analysis_Base.Abstract_Arithmetic.expression_domain_sound\<close> would assume
