theory Sign_Arithmetic
  imports Sign_Lattice "Voblint_VIMP.VIMP_Expr" "Voblint_Analysis_Base.Abstract_Arithmetic"
begin
...
text \<open>
  ...
  queries for \<open>Voblint_Analysis_Base.Abstract_Arithmetic\<close>'s \<open>expression_domain_sound\<close>
