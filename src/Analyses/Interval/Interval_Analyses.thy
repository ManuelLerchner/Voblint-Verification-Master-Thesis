...
text \<open>
  ...
  lives in \<^theory>\<open>Voblint_Analysis_Interval.Interval_Sound\<close> and mentions no context.
...
text \<open>
  ...
  every concrete value. Mirrors \<^theory>\<open>Voblint_Analysis_Interval.Interval_Exec_Sound\<close>'s
