...
corollary sign_mixed_flow_sound_and_optimal:
  ...
  shows
    "cfg_collect (compile_prog inc_pi [''p''] (Call None ''p'' [])) S
       (cfg_exit (compile_prog inc_pi [''p''] (Call None ''p'' [])))
     \<le> \<lbrakk>side_analyse_eff inc_pi [''p''] (Call None ''p'' []) sign_etf
          bot sign_init_s0 ()
...
proof -
  note result = mixed_flow_analysis_optimal
    [OF refl refl sign_sound_etf sign_etf_threefold_mono sign_etf_cone_compatible
        dom S_sound]
  show "cfg_collect (compile_prog inc_pi [''p''] (Call None ''p'' [])) S
          (cfg_exit (compile_prog inc_pi [''p''] (Call None ''p'' [])))
        \<le> \<lbrakk>side_analyse_eff inc_pi [''p''] (Call None ''p'' []) sign_etf
             bot sign_init_s0 ()
             (cfg_exit (compile_prog inc_pi [''p''] (Call None ''p'' [])))\<rbrakk>"
...
corollary sign_mixed_flow_sound_from_pp:
  ...
  assumes pp:
    "part_post_solution
       (side_cfg_T_eff (compile_prog inc_pi [''p''] (Call None ''p'' []))
          sign_etf bot sign_init_s0 ()) (cfg_exit (compile_prog inc_pi [''p''] (Call None ''p'' []))) \<sigma> vars"
  assumes entry:
  ...
  shows
    "cfg_collect (compile_prog inc_pi [''p''] (Call None ''p'' [])) S
       (cfg_exit (compile_prog inc_pi [''p''] (Call None ''p'' [])))
     \<le> \<lbrakk>side_env \<sigma> (cfg_exit (compile_prog inc_pi [''p''] (Call None ''p'' [])))\<rbrakk>"
