...
theory Example_Interval_Side_Proc_Global
  imports "Voblint_Analysis.Interval_Side_IP_Soundness" "Voblint_CFG.CFG_Collect_IP_Adeq"
begin
...
proof -
  ...
  show ?thesis
    by (rule side_ip_ivl_analysis_sound[OF s_sound collect_exit side_solve_dom])
qed
