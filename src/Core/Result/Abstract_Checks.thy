theory Abstract_Checks
  imports Checks CFG_Enumeration Analysis_Result "Voblint_Domain.Abstract_Numeric_Queries"
begin
...
text \<open>
  ...
  \<^theory>\<open>Voblint_Domain.Abstract_Domain\<close>'s \<open>backward_domain\<close> locale takes for its own
