...
lemma placed_hook_se_edge:
  fixes gs :: "vname => bool"
    ...
    and transfer_st :: "edge_action => ('a::cast_domain) exec_dg_st => 'a exec_dg_st"
    and transfer_abs :: "edge_action => 'a abs_state => 'a abs_state"
    and enter_st :: "vname list => texp list => 'a exec_dg_st => 'a exec_dg_st"
    and enter_abs :: "vname list => texp list => 'a abs_state => 'a abs_state"
