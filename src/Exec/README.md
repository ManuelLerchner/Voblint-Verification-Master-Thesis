...
| `DG_Base_Exec.thy` | The executable Base-style spec, and `routed_dg_domain_exec`: the three commute facts a domain owes |
| `Routed_Domain_Exec.thy` | The routed layer, once for every domain and context policy |
