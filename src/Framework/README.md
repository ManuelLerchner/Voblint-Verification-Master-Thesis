...
| `sound_dg_spec` | a joint concretization `gammaDG d g` the compiled trees' observations over-approximate | `Spec/DG_Spec_Sound.thy` |
...
Entry is deliberately absent from `sound_dg_spec`. A call answers a *list* of
