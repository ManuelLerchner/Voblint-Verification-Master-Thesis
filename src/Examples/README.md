...
| File | Role |
| --- | --- |
| `Example_Sign_Analysis.thy` | Runnable sign analysis (`TD_Interface`) |
| `Example_Interval_Analysis.thy` | Runnable interval analysis (`TD_Interface`) |
...
`Example_CFG_Collecting_Equiv`, `Example_GraphViz`, `Example_NonTerminating_Safe`, plus
main target `Goblint_Formalization`.
