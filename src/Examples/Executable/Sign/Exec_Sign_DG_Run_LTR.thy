...
text \<open>
  ...
  @{thm [source] sign_dg_post_solution_collect_sound_ltr}, never routing through
  \<open>ltr_collect_le_cfg_collect\<close>.  The broad @{thm [source] dgEx_collect_sound} stays available for
  compatibility.
...
theorem dgEx_collect_sound_ltr:
  ...
  by (rule sign_dg_post_solution_collect_sound_ltr
