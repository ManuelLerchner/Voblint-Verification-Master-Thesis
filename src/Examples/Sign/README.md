...
| `Example_Sign_Custom_Combine.thy` | canonical spine | an analysis-supplied call-return combine that is *not* `combine_env_abs`, carried through the same generic soundness |
