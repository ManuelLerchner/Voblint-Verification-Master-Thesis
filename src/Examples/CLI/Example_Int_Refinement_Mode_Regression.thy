...
text \<open>
  ...
  and why the weaker mode or component could not have derived it alone. \<^theory>\<open>Voblint_Examples_Int.Example_Int_Domain\<close>
...
text \<open>
  ...
  stayed reachable exclusively through \<^theory>\<open>Voblint_Analysis_Int.Int_Exec\<close>'s
  own bundles (\<^const>\<open>int_tf_st_never_for\<close> etc., exercised directly above by
  \<^theory>\<open>Voblint_Examples_Int.Exec_Int_DG_Run\<close>), never through
  \<^const>\<open>analyse_int_dg_eqs_for\<close>/\<^const>\<open>analyse_int_dg_env_for\<close>
  (\<^theory>\<open>Voblint_Analysis_Int.Int_Exec_Sound\<close>) -- the actual production
  ...
  reruns \<^theory>\<open>Voblint_Examples_Int.Exec_Int_DG_Run\<close>'s own
...
text \<open>
  ...
  \<^theory>\<open>Voblint_Analysis_Int.Int_Exec_Sound\<close>): no new proof obligation, no
