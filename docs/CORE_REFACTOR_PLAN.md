...
`Voblint_Framework`, written to be followed directly. Edit it as phases land:
...
| 3.4 | Hoist `dg_post_solution_postfix` (272 lines) and `routed_node_rhs_buffered_correspondence` (249) into helper lemmas with named subgoals. | open |
