...
It records the `trace_witness_act` spine of that time, since deleted. Its successor is
[`ACTIVATION_LOCAL_TRACE_CONVERGENCE.md`](../ACTIVATION_LOCAL_TRACE_CONVERGENCE.md): `valid_ltr`
is the concrete foundation while this document's public DG path is retained.
