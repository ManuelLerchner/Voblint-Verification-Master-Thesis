...
Status: superseded. The digest spine it designs against (`Digest_Global_Read`, `reader_digest`,
`obs_digest`, the reaching-definitions instance) was removed; see
`docs/history/DIGEST_SPINE_REMOVAL_PLAN.md`.
