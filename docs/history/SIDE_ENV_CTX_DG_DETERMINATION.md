...
> **Status:** historical. The effectful unit-context endpoint was deleted, and
> `TD_Side_Eff_Ctx_Shared` with it. Context soundness is now the
> `routed_context_base_hetero` locale
