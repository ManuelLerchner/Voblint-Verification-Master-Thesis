...
interface is documented in `src/Abstract_Interpreter/Domain/README.md` and by
the `sound_transfer_for` locale in
`src/Abstract_Interpreter/Framework/Spec/DG_Local_State_Spec.thy`; this file
preserves the earlier migration plan and mentions retired paths and locale
names.
