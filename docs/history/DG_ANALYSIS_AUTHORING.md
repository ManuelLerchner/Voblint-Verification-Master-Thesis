...
> **Status:** historical. Every path, locale and combinator named below is
> retired. Current guidance: "One generator, six layers" in
> `src/Abstract_Interpreter/Framework/README.md`, the "Writing a transfer"
> subsection of `src/Abstract_Interpreter/Framework/Spec/DG_Spec.thy`, and
> `docs/ANALYSIS_ASSEMBLY_GENERATION.md` for registering a domain.
