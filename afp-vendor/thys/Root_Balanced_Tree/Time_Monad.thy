(* Vendored from AFP entry Root_Balanced_Tree (Tobias Nipkow, 2017).
   Source: https://www.isa-afp.org/entries/Root_Balanced_Tree.html
   Only this file is needed; the rest of the entry was omitted to avoid
   transitive AFP dependencies (Amortized_Complexity, HOL-Data_Structures). *)
