...
| activation&#95;collect 𝒢 R startcontext g S v c<br>𝒜 v c exists only where a locale fixes its environment: within `ltr_coverage` | the stores collected at _v_ in context _c_ | [`activation_collect`](https://manuellerchner.github.io/Voblint-Verification-Master-Thesis/Voblint/Voblint_CFG/LTR_Activation_Context.html#LTR_Activation_Context.activation_collect%7Cconst) | the stores valid traces carrying context _c_ reach at node _v_; _R_ admits callee contexts and the root runs in _startcontext_ |
