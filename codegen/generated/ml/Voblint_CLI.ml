...
type ('a, 'b, 'c, 'd, 'e) man_ext =
  Man_ext of
    'c * (('d -> ('a, 'b, ('c, 'd) dg_state) strategy_tree) ->
           ('a, 'b, ('c, 'd) dg_state) strategy_tree) *
      ('d ->
        (unit -> ('a, 'b, ('c, 'd) dg_state) strategy_tree) ->
          ('a, 'b, ('c, 'd) dg_state) strategy_tree) *
      'e;;
...
type ('a, 'b, 'c, 'd, 'e) dg_spec_ext =
  Dg_spec_ext of
    (('a, 'b, 'c, 'd, unit) man_ext ->
      ('c -> ('a, 'b, ('c, 'd) dg_state) strategy_tree) ->
        ('a, 'b, ('c, 'd) dg_state) strategy_tree) *
      (string ->
        exp ->
          ('a, 'b, 'c, 'd, unit) man_ext ->
      ...
      (unit call_info_ext ->
        ('a, 'b, 'c, 'd, unit) man_ext ->
          'c -> ('c -> ('a, 'b, ('c, 'd) dg_state) strategy_tree) ->
                  ('a, 'b, ('c, 'd) dg_state) strategy_tree) *
      (unit call_info_ext ->
        ('a, 'b, 'c, 'd, unit) man_ext ->
          'c -> ('c -> ('a, 'b, ('c, 'd) dg_state) strategy_tree) ->
...
let rec mk_dg_man _A d gk = Man_ext (d, dg_read_global gk, dg_sideg _A gk, ());;
...
let rec dg_edge_tree_man _C
  transfer src gk =
    sp_bind (dg_read_at src) (fun d -> transfer (mk_dg_man _C d gk));;

let rec transfer_tree _C _D
  t src gk =
    sp_run_with (fun d -> DG (d, bot _D)) (dg_edge_tree_man _C t src gk);;
...
let rec dg_spec_edge_tree _C _D
  s a src gk = transfer_tree _C _D (dg_spec_step s a) src gk;;
        ...
        dg_spec_edge_tree
          ...
          (bot_lifted
            (semilattice_sup_resolved_st_q
              (bounded_semilattice_sup_bot_int_dom_ext
                int_dom_record_lattice_unit)))
          (ictx_spec mode empty_pred gs) a src Global)
      (routed_cmb_g
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q
            (bounded_semilattice_sup_bot_int_dom_ext
        ...
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q
            (bounded_semilattice_sup_bot_int_dom_ext
              int_dom_record_lattice_unit)))
        (ictx_spec mode empty_pred gs) Global (fun a b -> Seed (a, b))
    ...
    side_cfg_T_eff_keyed_seed_dg_buffered equal_gka
      ...
      (fun _ src a ->
        dg_spec_edge_tree
          ...
          (bot_lifted
            (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_sign))
          (sctx_spec gs empty_pred) a src Globala)
      (routed_cmb_g
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_sign))
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_sign))
        (sctx_spec gs empty_pred) Globala (fun a b -> Seeda (a, b))
        (static_resolve (compile_prog pi ps)))
      (routed_extra_g
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_sign))
    ...
    side_cfg_T_eff_keyed_seed_dg_buffered equal_gkb
      ...
      (fun _ src a ->
        dg_spec_edge_tree
          ...
          (bot_lifted
            (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_parity))
          (pctx_spec gs empty_pred) a src Globalb)
      (routed_cmb_g
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_parity))
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_parity))
        (pctx_spec gs empty_pred) Globalb (fun a b -> Seedb (a, b))
        (static_resolve (compile_prog pi ps)))
      (routed_extra_g
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_parity))
    ...
    side_cfg_T_eff_keyed_seed_dg_buffered equal_gkc
      ...
      (fun _ src a ->
        dg_spec_edge_tree
          ...
          (bot_lifted
            (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_ivl))
          (ictx_speca gs empty_pred) a src Globalc)
      (routed_cmb_g
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_ivl))
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_ivl))
        (ictx_speca gs empty_pred) Globalc (fun a b -> Seedc (a, b))
        (static_resolve (compile_prog pi ps)))
      (routed_extra_g
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_ivl))
        ...
        dg_spec_edge_tree
          ...
          (bot_lifted
            (semilattice_sup_resolved_st_q
              (bounded_semilattice_sup_bot_int_dom_ext
                int_dom_record_lattice_unit)))
          (ictx_spec mode empty_pred gs) a src Globalg)
      (routed_cmb_g
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q
            (bounded_semilattice_sup_bot_int_dom_ext
        ...
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q
            (bounded_semilattice_sup_bot_int_dom_ext
              int_dom_record_lattice_unit)))
        (ictx_spec mode empty_pred gs) Globalg (fun a b -> Seedg (a, b))
        (static_resolve (compile_prog pi ps)))
      (routed_extra_g
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q
    ...
    side_cfg_T_eff_keyed_seed_dg_buffered equal_call_string_gk
      ...
      (fun _ src a ->
        dg_spec_edge_tree
          ...
          (bot_lifted
            (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_sign))
          (sctx_spec gs empty_pred) a src Globalg)
      (routed_cmb_g
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_sign))
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_sign))
        (sctx_spec gs empty_pred) Globalg (fun a b -> Seedg (a, b))
        (static_resolve (compile_prog pi ps)))
      (routed_extra_g
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_sign))
...
let rec ictx_entry_route_gen
  mode gs empty_pred u ctx d ca = ictx_entry_route mode gs empty_pred d ca;;
        ...
        dg_spec_edge_tree
          ...
          (bot_lifted
            (semilattice_sup_resolved_st_q
              (bounded_semilattice_sup_bot_int_dom_ext
                int_dom_record_lattice_unit)))
          (ictx_spec mode empty_pred gs) a src Globald)
      (routed_cmb_g
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q
            (bounded_semilattice_sup_bot_int_dom_ext
        ...
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q
            (bounded_semilattice_sup_bot_int_dom_ext
              int_dom_record_lattice_unit)))
        (ictx_spec mode empty_pred gs) Globald (fun a b -> Seedd (a, b))
        (static_resolve (compile_prog pi ps)))
      (routed_extra_g
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q
    ...
    side_cfg_T_eff_keyed_seed_dg_buffered equal_gke
      ...
      (fun _ src a ->
        dg_spec_edge_tree
          ...
          (bot_lifted
            (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_sign))
          (sctx_spec gs empty_pred) a src Globale)
      (routed_cmb_g
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_sign))
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_sign))
        (sctx_spec gs empty_pred) Globale (fun a b -> Seede (a, b))
        (static_resolve (compile_prog pi ps)))
      (routed_extra_g
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_sign))
    ...
    side_cfg_T_eff_keyed_seed_dg_buffered equal_gkf
      ...
      (fun _ src a ->
        dg_spec_edge_tree
          ...
          (bot_lifted
            (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_ivl))
          (ectx_spec gs empty_pred) a src Globalf)
      (routed_cmb_g
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_ivl))
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_ivl))
        (ectx_spec gs empty_pred) Globalf (fun a b -> Seedf (a, b))
        (static_resolve (compile_prog pi ps)))
      (routed_extra_g
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_ivl))
    ...
    side_cfg_T_eff_keyed_seed_dg_buffered equal_call_string_gk
      ...
      (fun _ src a ->
        dg_spec_edge_tree
          ...
          (bot_lifted
            (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_ivl))
          (ectx_spec gs empty_pred) a src Globalg)
      (routed_cmb_g
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_ivl))
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_ivl))
        (ectx_spec gs empty_pred) Globalg (fun a b -> Seedg (a, b))
        (static_resolve (compile_prog pi ps)))
      (routed_extra_g
        (bounded_semilattice_sup_bot_lifted
          (semilattice_sup_resolved_st_q bounded_semilattice_sup_bot_ivl))
